...
class TemporalEncoder(nn.Module):
    def __init__(self, params):
        ...
        # self.week_encoder = modules.EncoderTF(params, params.dim_embed_tim, params.head_num_tim, params.dim_enc_tim,
        #                                       params.num_enc_tim, params.traj_len)
        # loc compresssor
    ...
    def forward(self, tim_batch, loc_day_all, mask_day, mask_traj):
        ...
        tim_week = self.week_encoder(info_cat, mask_day)            # tim_week:(B, 2H)
